...
def call(extractTable,file,originalImg,basePath,expNo,indx):#
    vlines = []
    vLineLength = 50 #25
    ...
    #image = extractTable #file #cv2.imread(filePath)
    ...
    cv2.imwrite(basePath+expNo+ "/delMe/lineResults2//"+str(indx)+"all_lines.jpg",i)
